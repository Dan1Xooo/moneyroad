...
const process = [
  ...
  ["Выбор", "Выбирает продукты, которые готов рассмотреть для получения прибыли."],
      ...
      <section className="page-hero dark-section">
        <div className="container">
          <PageIntro
            ...
            description="Каждый этап понятен заранее. Сначала предварительный расчёт в калькуляторе, затем проверка условий через личное сообщение, только после этого оформление продуктов."
          />
        </div>
      </section>
