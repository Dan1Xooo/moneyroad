      ...
      <section className="hero dark-section">
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <h1>Рассчитайте, сколько можно получить за финансовые продукты</h1>
            <p className="hero-subtitle">
              Выберите подходящие банковские и финансовые предложения, выполните заранее
              известные условия и получите согласованное вознаграждение.
            </p>
            ...
            <p className="hero-note">
              Расчёт является предварительным. Доступность и точные условия каждого
              предложения подтверждаются перед оформлением.
            </p>
          </div>
          <HeroVisual />
        </div>
