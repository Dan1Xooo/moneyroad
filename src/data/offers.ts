...
export const offers: Offer[] = [
  {
    ...
    payout: 2450,
    payoutLabel: "до 2 450 ₽ за оформление",
    ...
    hiddenName: false,
    telegramLabel: "Дебетовая карта Альфа-Банка — до 2 450 ₽",
  },
  {
    id: "tbank-debit",
    category: "debit",
    ...
    shortName: "Т-Банк",
    payout: 2000,
    payoutLabel: "до 2 000 ₽ за оформление",
    ...
    warning: "Если карта уже была, предложение недоступно.",
    hiddenName: false,
    telegramLabel: "Дебетовая карта Т-Банка — до 2 000 ₽",
  },
  {
    id: "ozon-debit",
    category: "debit",
  ...
  },
  {
    ...
    newClientOnly: false,
    active: true,
    description: "Условия по МФО обговариваются строго в личных сообщениях.",
    conditions: [
      "Взять МФО со сроком от 10 дней",
      "Условия по МФО обговариваются строго в личных сообщениях",
    ],
